...
/// <summary>
/// CyberTechRep 插件入口：向 ClassIsland 宿主 DI 容器注册服务。
/// 已注册：模块 1 消息接入、模块 2 消息分类、模块 3 三级学科识别链；
/// 设置页/悬浮窗/文件管道由后续模块追加。
/// </summary>
[SupportedOSPlatform("windows")]
[PluginEntrance]
public class CyberTechRepPlugin : PluginBase
{
    public override void Initialize(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddSettingsPageGroup("cybertechrep.settings", "\uE713", "CyberTechRep");
        ...
        services.AddSingleton<SubjectSelectionSuspensionWindow>(sp => new SubjectSelectionSuspensionWindow(
            ...
            () => CyberTechRep.Plugin.Services.SubjectChain.SubjectRuleFile
