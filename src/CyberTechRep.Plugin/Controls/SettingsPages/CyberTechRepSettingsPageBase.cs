...
/// <summary>
/// CyberTechRep 设置页公共基类：注入 <see cref="ISettingsService"/>，以
...
public abstract class CyberTechRepSettingsPageBase : SettingsPageBase, INotifyPropertyChanged
{
    ...
    protected CyberTechRepSettingsPageBase(ISettingsService settingsService, string dataDirectory)
    {
